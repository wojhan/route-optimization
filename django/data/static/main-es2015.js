...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<section id=\"login\" class=\"d-flex flex-row justify-content-center align-items-center\">\n    <div id=\"login-box\">\n        <div class=\"row\">\n            <div class=\"col\">\n                <h1>Zaloguj się</h1>\n            </div>\n        </div>\n        <div class=\"row\">\n            <div class=\"col\">\n                <input class=\"form-control form-control-lg\" type=\"text\" placeholder=\"login\" [(ngModel)]=\"user.username\"\n                    name=\"login-username\">\n                <span *ngFor=\"let error of _userService.errors.username\"><br />\n                    {{ error }}</span>\n                <input class=\"form-control form-control-lg\" type=\"text\" placeholder=\"hasło\" [(ngModel)]=\"user.password\"\n                    name=\"login-password\">\n                <span *ngFor=\"let error of _userService.errors.password\"><br />\n                    {{ error }}</span>\n                <button (click)=\"login()\" class=\"btn btn-block btn-primary\">Submit</button>\n            </div>\n        </div>\n        <div class=\"row\">\n            <span *ngFor=\"let error of _userService.errors.non_field_errors\">{{ error }}<br /></span>\n        </div>\n        <div class=\"row\">\n            <div class=\"col text-right\">\n                <p class=\"login-helper\">Nie pamiętam hasła</p>\n            </div>\n        </div>\n        <div class=\"row\">\n            <div class=\"col text-right\">\n                <p class=\"login-helper\">Nie masz jeszcze konta? <a>Założ konto.</a></p>\n            </div>\n        </div>\n    </div>\n</section>");
...
const routes = [
    { path: "logout", component: _login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"] },
    { path: "login", component: _login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"] },
    { path: "dashboard", component: _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_4__["DashboardComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]] }
];
...
let AppComponent = class AppComponent {
    constructor(_userService, _authService, router) {
    ...
    ngOnInit() {
        ...
        if (this._authService.getIsAuthenticated()) {
            this._userService.getUsername().subscribe(username => (this.user = { username }), err => console.log(err), () => {
...
let UserService = class UserService {
    ...
    getUsername() {
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => data["username"]));
    }
    logout() {
        this.token = null;
...
module.exports = __webpack_require__(/*! /home/wojciech/Pulpit/route-optimization/angular/src/main.ts */"./src/main.ts");
